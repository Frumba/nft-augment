...
const ErdInput = () => {
  const { addressId, setAddressId } = useSession();
  ...
  return (
    ...
    >
      <input
        defaultValue={addressId ?? undefined}
        ...
        required
      />
      <input className="p-4 rounded bg-blue-400 text-white cursor-pointer" type="submit" value="Send" />
    </form>
  );
};
